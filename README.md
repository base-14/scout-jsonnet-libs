...
Current release: `v0.3.2` — declarable noDataState, counter-delta alert series, time-series alert queries for multi-dimensional
...
```sh
jb install github.com/base-14/scout-jsonnet-libs@v0.3.2
```
